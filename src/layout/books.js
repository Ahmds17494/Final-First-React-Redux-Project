...
let resBooks = await axios.get('http://localhost:3003/Favorite'); 
let AllBooks = resBooks.data;    

setMyFavorite(AllBooks)
...
<div className="row"> <h1 className="title" id="Category" >My Favorites {i}</h1> </div>
     <div className="row userDisplay" >
     
         
{ myFavorite.map((myFavorite,index) =>  
                            {  
                           ...
                           return ( ( <React.Fragment>
                               ...
                               {( myFavorite.Email == userDetailes.email) ? 
                                   
                                <div key={index} className="col-3 d-flex userBooks">
                                <div className=""><img id="imgHover" src={myFavorite.Image} alt="xx" onClick={addDescriptionn(myData)}/> </div>
                                <i class="fa fa-heart iconFont" aria-hidden="true"></i>
